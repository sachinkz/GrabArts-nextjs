            ...
            <div className='flex w-full mt-3 justify-between max-lg:flex-col'>
                <Link href="https://brustro.in/products/brustro-bristol-ultra-smooth-paper-250-gsm-size-a2-10-sheets">
                    <div className='hover:scale-105 transition-transform duration-200 cursor-pointer p-2 flex flex-col items-center gap-3 '>
                        <Image className='rounded-lg h-full object-contain' width={100} height={200} alt='ad bristol' src="https://artcetera.in/wp-content/uploads/2023/07/A3-1.png" />
                ...
                <Link href="https://brustro.in/products/brustro-bristol-ultra-smooth-paper-250-gsm-size-a2-10-sheets">
                    <div className='hover:scale-105 transition-transform duration-200 cursor-pointer p-2 flex flex-col items-center gap-3'>
                        <Image className='rounded-lg h-full object-contain' width={100} height={200} alt='ad bristol' src="https://images-na.ssl-images-amazon.com/images/I/81SM1+KmiNL._AC_UL600_SR600,600_.jpg" />
                        <button className='bg-secondary text-xs flex justify-center items-center gap-1 rounded-md px-3 py-1'>Purchase <ArrowUpRight className='w-5 mt-1 h-5' /></button>
                    </div>
                </Link>
                ...
                <Link href="https://brustro.in/products/brustro-bristol-ultra-smooth-paper-250-gsm-size-a2-10-sheets">
                    <div className='hover:scale-105 transition-transform duration-200 cursor-pointer p-2 flex flex-col items-center gap-3'>
                        <Image className='rounded-lg h-full object-contain' width={100} height={200} alt='ad bristol' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT6JyFgU7zF3DolZsFky3KlmOL4XVT_xIqYxsSWFyWyGG-f4bv4NdlDAtXL3A3x8lod0DM&usqp=CAU" />
                        <button className='bg-secondary text-xs flex justify-center items-center gap-1 rounded-md px-3 py-1'>Purchase <ArrowUpRight className='w-5 mt-1 h-5' /></button>
                    </div>
                </Link>
